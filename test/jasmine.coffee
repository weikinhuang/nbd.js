...
class PhantomJasmineRunner
  ...
  get_status: -> @page.evaluate(-> return reporter.status for reporter in jasmine.getEnv().reporter.subReporters_ when reporter instanceof jasmine.ConsoleReporter)
